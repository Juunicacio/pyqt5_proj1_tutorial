...
from PyQt5.QtGui import (QPen, QBrush, QColor, QConicalGradient, QCursor, QFont, QFontDatabase, QIcon, QKeySequence, QLinearGradient, QPalette, QPainter, QPixmap, QRadialGradient)
...
class MyCustomLabel(QLabel):
    ...
    def drawHorizontalLine(self, i):
        line1 = QPainter(self)
        line1.setPen(QPen(Qt.black, 3, Qt.SolidLine))

        # Values for the Minimum Size of the Window
        line1.drawLine(self.widthMarginLine(), self.layers_level[i], self.widthMarginLine()+self.width_lines, self.layers_level[i]) 
    ...
    def paintEvent(self, event):
        ...
        line1.drawLine(self.widthMarginLine(), 135, self.widthMarginLine()+self.width_lines, 135)     

class MyCustomMainWindow(QMainWindow):    
    def __init__(self):
        super().__init__()
        self.WINDOWHEIGHT = 567 +1+ 20 # layers_level[1] + offset + margin_height
