...
START_RIGHT_LINES = MARGIN_WIDTH-5 # 65
WIDTH_LINES = 8

# DEFINITIONS FOR THE GRAPH - LEFT HORIZONTAL LINE
START_LEFT_LINES = MARGIN_WIDTH-12.5 # 57.5
...
class MyCustomLabel(QLabel):
    ...
    #def drawVerticalLine(self, i):
        ...
        #layers_left_text.drawText(LEFT_TEXT_OFFSET,LAYERS_LEVEL[i]+TEXT_DISTANCES, meters_deep)
        ...
        if i <= 9: #!= (10 and 11):
            ...
            layers_left_text.translate(LEFT_TEXT_OFFSET,LAYERS_LEVEL[i]+1)#+TEXT_DISTANCES)
        elif i == 10:
            doc_left_text.setHtml(f"<font size=-1><b><p align=center>below<br>{meters_deep}<br>meters</b></font></p>")
            layers_left_text.translate(LEFT_TEXT_OFFSET,LAYERS_LEVEL[i]-2)#-UP_OFFSET_LEFT_TEXT)#+TEXT_DISTANCES)
        else:
            doc_left_text.setHtml(f"<font size=+1><b><p align=center>{meters_deep}</b></font></p>")
            layers_left_text.translate(LEFT_TEXT_OFFSET-1,LAYERS_LEVEL[i]+UP_OFFSET_LEFT_TEXT)#+TEXT_DISTANCES)
        ...
        if i <= 9: #!= 11:
            ...
            # Draw Right Text
            #layers_right_text.drawText(self.widthMarginLine()+RIGHT_TEXT_OFFSET,LAYERS_LEVEL[i]+TEXT_DISTANCES, f"Layer {i+1}")
            # Draw Text with QTextDocument
    ...
    def paintEvent(self, event):
        ...
        # Draw Layers
        self.drawLayer('#c9f2e7', 0, "0-5") # #a5ffe7 # #c7fcee # #cffff2 # #c9f2e7
        ...
        self.drawLayer('#0014cc', 9, "111-4095") # #0217a3 # #0018cf # #0015cf # #0014cc
        self.drawLayer('#0502b0', 10, "4096") # #0400c6 # #05038f # #0502b0
        self.drawLayer('#5e512e', 11, "Seabed") # #9e8952 # #857244 # #5e512e  
...
if __name__ == "__main__":
    ...
    #LAYERS_LEVEL.append(RECT_LAYERS_START + RECT_LAYERS_HEIGHT + 1)
